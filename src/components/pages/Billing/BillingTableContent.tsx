 ...
 * Mock data matching the billing table design (Inv-2001..2005, Issue Date 2025-03-22, Value £ 1,500.00, Payment Date 2025-08-01, Status Unpaid/Paid/Overdue) is in @/lib/data.ts (MOCK_BILLING_DATA).
 */
